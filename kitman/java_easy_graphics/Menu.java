// This program should allow the user access a menu to draw a line, a square
// and add text into an easy graphics display. also it should give the user 
// an option to save or load up old pictures.
